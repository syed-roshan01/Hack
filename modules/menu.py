    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Hack"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/rajkumardusad/Hack.git "+system.home+"/Hack")
            if os.path.exists(system.home+"/Hack/install.aex"):
              os.system("cd "+system.home+"/Hack && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Hack"):
              ...
              os.system("git clone https://github.com/rajkumardusad/Hack.git "+system.home+"/Hack")
            if os.path.exists(system.home+"/Hack/install.aex"):
              os.system("cd "+system.home+"/Hack && sh install.aex")
              if os.path.exists(system.bin+"/Hack") and os.path.exists(system.conf_dir+"/Hack"):
                os.system("clear")
                logo.updated()
                cmd=input("\033[1;36m ##> \033[00m")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall tool-x" or cmd=="unistall Hack":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Hack")
          os.system(system.sudo+" rm -rf "+system.bin+"/hack")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Hack")
        else:
          os.system("rm -rf "+system.bin+"/Hack")
          os.system("rm -rf "+system.bin+"/hack")
          os.system("rm -rf "+system.conf_dir+"/Hack")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Hack/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Hack/core/cat.json") as cat_file:
